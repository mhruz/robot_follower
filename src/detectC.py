...
def distance2bbox(points, distance, max_shape=None):
    ...
    ----------
        points : Tensor
            Shape (n, 2), [x, y].
        distance : Tensor
            Distance from the given point to 4 boundaries (left, top, right, bottom).
        max_shape : tuple
            Shape of the image.
    Returns
    -------
...
class SCRFD:
    ...
    def detect(self,img,thresh=0.5,max_num=0,metric='default'):
